...
- Name: gamification-training-flow.spec.ts >> Gamification + Training Flow E2E >> should prevent XP fraud (RLS policy test)
- Location: e2e\gamification-training-flow.spec.ts:128:7
