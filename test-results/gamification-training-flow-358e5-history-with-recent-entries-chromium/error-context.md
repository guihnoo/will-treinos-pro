...
- Name: gamification-training-flow.spec.ts >> Gamification + Training Flow E2E >> should show XP history with recent entries
- Location: e2e\gamification-training-flow.spec.ts:108:7
