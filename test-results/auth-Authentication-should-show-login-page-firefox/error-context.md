...
Locator: locator('text=Will Treinos PRO')
Expected: visible
Error: strict mode violation: locator('text=Will Treinos PRO') resolved to 2 elements:
    1) <h1 class="text-4xl sm:text-5xl font-black italic uppercase tracking-tighter text-center mb-1 shimmer-text">WILL TREINOS PRO</h1> aka getByRole('heading', { name: 'WILL TREINOS PRO' })
    2) <p class="text-[10px] text-white/20 uppercase tracking-widest">Est. 2024 · Will Treinos PRO · v2.0 Elite</p> aka getByText('Est. 2024 · Will Treinos PRO')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=Will Treinos PRO')
